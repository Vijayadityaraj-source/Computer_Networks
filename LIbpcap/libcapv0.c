...
int main(int argc,char* argv[])
{
    ...
    char* ip_addr_to_sniff = argv[1];
    char* port_to_sniff = argv[2];
    bpf_u_int32 mask;
    bpf_u_int32 net;
    struct bpf_program fp;
    char ipaddr[20];
    sprintf(ipaddr,"host %s and port %s",ip_addr_to_sniff,port_to_sniff);
    ...
    //change the value=10 to 0 to make it sniff indefinetly.
